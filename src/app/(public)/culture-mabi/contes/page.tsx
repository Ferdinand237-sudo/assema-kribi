...
export default async function PageContesLegendes() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <h1 className="mb-2 mt-2 font-display text-3xl font-semibold text-encre">Contes & légendes Mabi</h1>
      <p className="mb-8 text-encre/70">Le folklore et les récits transmis de génération en génération.</p>
      ...
      {articles && articles.length > 0 ? (
        ...
        <p className="text-sm text-encre/60">Aucun conte publié pour le moment.</p>
      )}
    </div>
  )
}